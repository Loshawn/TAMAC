...
def get_args_parser():
    ...
    parser.add_argument('--position_embedding',
                        default='sine',
                        type=str,
    ...
    parser.add_argument('--ckpt_dir',
                        default="ckpt/sim_insertion_scripted/ori-2.20",
                        action='store',
                        type=str,
                        help='ckpt_dir',
                        required=False)
    ...
    parser.add_argument('--task_name',
                        default="sim_insertion_scripted",
                        action='store',
                        type=str,
                        help='task_name',
                        required=False)
    ...
    parser.add_argument('--use_full_seq', action='store_true')
...
def build_TAMAC_model_and_optimizer(args_override):
    parser = argparse.ArgumentParser('DETR training and evaluation script',
                                     parents=[get_args_parser()])
    args = parser.parse_args()
